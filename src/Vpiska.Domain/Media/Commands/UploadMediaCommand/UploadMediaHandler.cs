...
{
    internal sealed class UploadMediaHandler : ICommandHandler<UploadMediaCommand>
    {
        ...
        public async Task HandleAsync(UploadMediaCommand command, CancellationToken cancellationToken = default)
        {
