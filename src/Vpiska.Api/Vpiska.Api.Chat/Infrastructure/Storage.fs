module Vpiska.Api.Chat.Infrastructure.Storage
...
let private eventGroups = ConcurrentDictionary<string, ConcurrentDictionary<ConnectionId, UserInfo>>()
let private usersConnections = ConcurrentDictionary<string, ConnectionId>()
