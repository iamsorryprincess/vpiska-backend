...
type CommandHandler(mongoClient: MongoClient,
    ...
    let handle command =
        ...
        | Create args ->
            ...
            Logic.createUser checkUser createUser Security.hashPassword Jwt.encodeJwt args
        ...
        | SetCode args ->
            ...
            Logic.setVerificationCode setCode CloudMessaging.pushNotification args
        ...
        | Update args ->
            ...
            Logic.updateUser getUser checkPhone checkName uploadFile updateUser args
